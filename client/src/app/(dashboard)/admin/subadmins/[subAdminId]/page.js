...
export default function SubAdminProfile({ params }) {
  ...
  if (error) return (
    <div className="p-6">
      ...
      <Link href="/admin/subadmins" className="underline text-blue-600 mt-2 block">Back</Link>
    </div>
  );
  ...
  if (!subadmin) {
    return (
      <div className="p-6">
        ...
        <Link href="/admin/subadmins" className="underline text-blue-600 mt-2 block">
          Back
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-6 bg-gray-50 flex flex-col gap-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow flex items-center gap-6">
        ...
        <Link href="/admin/subadmins" className="text-sm hover:underline">
          ← Back
        </Link>
      </div>
