  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 flex items-start justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">
              {material.subject} • Sem {material.semester} • Section {material.section}
            </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          href={`/faculty/study-material/view/${material.id}`}
          className="px-3 py-1 rounded bg-[#C3EBFA]"
        >
          View
        </Link>

        <Link
          href={`/faculty/study-material/edit/${material.id}`}
        ...
        <button
          ...
          className="px-3 py-1 rounded bg-[#FAE27C]"
        >
