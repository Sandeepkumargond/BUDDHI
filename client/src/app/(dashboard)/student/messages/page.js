...
export default function StudentMessagesPage() {
    ...
    const handleSearch = async (query) => {
        ...
        try {
            setSearching(true);
            const response = await apiService.searchUsers('alumni', query);
    ...
    // Start new conversation with an alumni
    const handleStartConversation = async (alumni) => {
        try {
            const message = `Hi ${alumni.firstName}, I would like to connect with you for guidance.`;
            await startConversation(alumni._id, 'Alumni', message);
            setShowSearch(false);
            setSearchQuery('');
            setSearchResults([]);
        } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-900 mb-6">Alumni Connect</h1>
                    ...
                    <div className="flex h-full flex-col lg:flex-row" style={{ minHeight: '60vh' }}>
                        ...
                        <div className="w-full lg:w-1/3 border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-col">
                            ...
                            <div className="p-4 border-b border-gray-200">
                                ...
                                >
                                    {showSearch ? 'View Conversations' : 'Connect with Alumni'}
                                </button>
                                ...
                                {showSearch ? (
                                    ...
                                    <div className="p-2">
                                        ...
                                        {!searching && searchResults.length === 0 && searchQuery.length >= 2 && (
                                            <div className="text-center py-4 text-gray-500">No alumni found</div>
                                        )}
                                    ...
                                    <div className="p-2">
                                        ...
                                        {!loading && conversations.length === 0 && (
                                            <div className="text-center py-8 text-gray-500">
                                                ...
                                                <p className="text-sm mt-2">Click &quot;Connect with Alumni&quot; to start</p>
                                            </div>
                                        )}
                                        {conversations.map((conv) => (
                                            ...
                                            >
                                                <div className="flex items-start">
                                                    <div className="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center text-white font-semibold mr-3 flex-shrink-0">
                                    ...
                                    <div className="p-4 border-b border-gray-200 bg-white">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm text-gray-500">
                                                    {selectedConversation.otherParticipant?.currentDesignation && selectedConversation.otherParticipant?.currentCompany
                                                        ? `${selectedConversation.otherParticipant.currentDesignation} at ${selectedConversation.otherParticipant.currentCompany}`
                                                        : selectedConversation.otherParticipant?.currentCompany || 'Alumni'}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
